...
export default function Footer() {
  return (
    <footer
      ...
      className="relative overflow-hidden bg-[#fffaf5] text-[#1a1a2e]"
    >
      <Container className="relative pb-10 pt-10 sm:pt-14 lg:pb-12 lg:pt-20">
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(22rem,3.5fr)_minmax(0,6fr)_auto] lg:gap-16 xl:gap-24">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-12 sm:grid-cols-3 lg:gap-x-8">
              {navigation.map((column) => (
                <div key={column.title} className="min-w-0">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-[#1a1a2e]/60">
                    {column.title}
                  </h3>
                  <ul className="mt-6 space-y-4">
                    {column.links.map((link) => (
                      <li key={link.label}>
                        <Link
                          href={link.href}
                          className="inline-block text-sm font-bold text-[#1a1a2e] transition-transform duration-200 hover:translate-x-1 hover:text-[#f06400] focus-visible:text-[#f06400] sm:text-base"
                        >
                          {link.label}
                        </Link>
                      </li>
          ...
          <div className="hidden lg:flex relative items-stretch pl-12 border-l-2 border-dashed border-[#1a1a2e]/15">
            {/* Top and Bottom semi-circle cutouts to mimic a receipt tear */}
            <div className="absolute -top-3 -left-2.5 w-5 h-5 rounded-full bg-[#fffaf5]" />
            <div className="absolute -bottom-3 -left-2.5 w-5 h-5 rounded-full bg-[#fffaf5]" />
            
            <div className="flex flex-col justify-center w-12 gap-[3px] opacity-70 mix-blend-multiply py-8">
              {/* Abstract Barcode generated with divs */}
              {[4, 2, 8, 2, 6, 12, 2, 4, 1, 8, 4, 2, 1, 10, 4, 6, 2, 8, 2, 1].map((h, i) => (
                <div key={i} className="w-full bg-[#1a1a2e]" style={{ height: `${h}px` }} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 sm:mt-20">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="flex flex-col items-start gap-6 lg:flex-row lg:items-center lg:gap-10">
              <Logo variant="color" width={140} height={31} />
              <div className="flex flex-wrap items-center gap-3">
                <Link
                  href="/#cities"
                  className="inline-flex items-center gap-2 rounded-pill border border-[#1a1a2e]/10 px-4 py-2 text-xs font-bold text-[#1a1a2e]/80 transition-colors hover:border-[#f06400] hover:text-[#f06400]"
                >
            ...
            <div className="flex items-center gap-6 text-[#1a1a2e]/60">
              {/* Minimalist monochrome social icons */}
              <a href="#" className="transition-colors hover:text-[#f06400]" aria-label="TikTok">
              ...
              <a href="#" className="transition-colors hover:text-[#f06400]" aria-label="LinkedIn">
                <svg className="h-5 w-5 fill-currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href="#" className="transition-colors hover:text-[#f06400]" aria-label="X">
              ...
              <a href="#" className="transition-colors hover:text-[#f06400]" aria-label="Instagram">
          ...
          <div className="mt-10 flex flex-col-reverse gap-5 border-t border-[#1a1a2e]/10 pt-6 text-sm font-medium text-[#1a1a2e]/60 sm:flex-row sm:items-center sm:justify-between">
