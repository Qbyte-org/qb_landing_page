        ...
        <section id="waitlist-hero" className="relative z-10 flex min-h-[100svh] flex-col items-center justify-center px-0">
          ...
          <div className="relative z-10 mx-auto w-full max-w-xl">
            <div data-waitlist-enter className="hero-panel relative overflow-hidden rounded-t-[32px] bg-paper/[0.07] p-4 py-6 backdrop-blur-[14px] transition-colors duration-300 hover:bg-paper/[0.1] sm:p-8 sm:py-10">
              ...
              <p className="relative mb-4 px-2 text-center text-sm leading-relaxed text-apricot sm:mb-6 sm:px-0">
              ...
              <div data-waitlist-enter className="mt-8 flex flex-wrap items-center justify-center gap-2 sm:gap-4">
                <div className="relative flex w-auto max-w-full min-w-0 shrink-0 items-center gap-2 rounded-xl border border-paper/[0.102] bg-paper/[0.14] p-1 backdrop-blur-xl sm:gap-3">
                  <span className="relative z-10 flex size-9 shrink-0 items-center justify-center rounded-xl border border-brand-light/[0.28] bg-paper/[0.16] sm:size-12">
          ...
          <div data-waitlist-enter className="relative z-10 mx-auto mt-2 flex w-full flex-wrap items-center justify-center gap-2 sm:gap-4.5">
            {perks.map(({ label, icon: Icon }) => (
              <div key={label} className="relative flex w-auto max-w-full min-w-0 shrink-0 items-center gap-2 rounded-b-xl border border-paper/[0.102] bg-paper/[0.14] p-2 pr-3 backdrop-blur-xl sm:gap-3 sm:p-1 sm:pr-4">
                <span className="relative z-10 flex size-7 shrink-0 items-center justify-center rounded-b-xl border border-brand-light/[0.28] bg-paper/[0.16] sm:size-12">
